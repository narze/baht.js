...
const SUB_HUNDRED =
  [
    ...
    "หกสิบ", "หกสิบเอ็ด", "หกสิบสอง", "หกสิบสาม", "หกสิบสี่", "หกสิบห้า", "หกสิบหก", "หกสิบเจ็ด", "หกสิบแปด", "หกสิบเก้า", "เจ็ดสิบ",
...
export function convert(input: number): string | boolean {
  ...
  if (!baht && !satangs) { return "ศูนย์บาทถ้วน" }
